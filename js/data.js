    ...
    categories: [
      {
        ...
        cards: [
          { name: 'うさぎ',     emoji: '🐰', imageUrl: 'images/cards/animals/usagi.png' },
          { name: 'いぬ',       emoji: '🐶', imageUrl: 'images/cards/animals/inu.png' },
          { name: 'ねこ',       emoji: '🐱', imageUrl: 'images/cards/animals/neko.png' },
          { name: 'ぞう',       emoji: '🐘', imageUrl: 'images/cards/animals/zou.png' },
          { name: 'きりん',     emoji: '🦒', imageUrl: 'images/cards/animals/kirin.png' },
          { name: 'らいおん',   emoji: '🦁', imageUrl: 'images/cards/animals/raion.png' },
          { name: 'ぱんだ',     emoji: '🐼', imageUrl: 'images/cards/animals/panda.png' },
          { name: 'さる',       emoji: '🐵', imageUrl: 'images/cards/animals/saru.png' },
          { name: 'くま',       emoji: '🐻', imageUrl: 'images/cards/animals/kuma.png' },
          { name: 'ぶた',       emoji: '🐷', imageUrl: 'images/cards/animals/buta.png' },
          { name: 'ひつじ',     emoji: '🐑', imageUrl: 'images/cards/animals/hitsuji.png' },
          { name: 'うし',       emoji: '🐄', imageUrl: 'images/cards/animals/ushi.png' },
          { name: 'にわとり',   emoji: '🐔', imageUrl: 'images/cards/animals/niwatori.png' },
          { name: 'かめ',       emoji: '🐢', imageUrl: 'images/cards/animals/kame.png' },
          { name: 'いるか',     emoji: '🐬', imageUrl: 'images/cards/animals/iruka.png' },
          { name: 'たか',       emoji: '🦅', imageUrl: 'images/cards/animals/taka.png' },
          { name: 'きつね',     emoji: '🦊', imageUrl: 'images/cards/animals/kitsune.png' },
          { name: 'おおかみ',   emoji: '🐺', imageUrl: 'images/cards/animals/ookami.png' },
          { name: 'りす',       emoji: '🐿️', imageUrl: 'images/cards/animals/risu.png' },
          { name: 'ぺんぎん',   emoji: '🐧', imageUrl: 'images/cards/animals/pengin.png' }
        ]
      },
      {
        id: 'foods', name: 'くだもの・やさい', color: '#f6c8b0',
        cards: [
          { name: 'りんご',       emoji: '🍎', imageUrl: 'images/cards/foods/ringo.png' },
          { name: 'ばなな',       emoji: '🍌', imageUrl: 'images/cards/foods/banana.png' },
          { name: 'いちご',       emoji: '🍓', imageUrl: 'images/cards/foods/ichigo.png' },
          { name: 'みかん',       emoji: '🍊', imageUrl: 'images/cards/foods/mikan.png' },
          { name: 'ぶどう',       emoji: '🍇', imageUrl: 'images/cards/foods/budou.png' },
          { name: 'すいか',       emoji: '🍉', imageUrl: 'images/cards/foods/suika.png' },
          { name: 'もも',         emoji: '🍑', imageUrl: 'images/cards/foods/momo.png' },
          { name: 'さくらんぼ',   emoji: '🍒', imageUrl: 'images/cards/foods/sakuranbo.png' },
          { name: 'なし',         emoji: '🍐', imageUrl: 'images/cards/foods/nashi.png' },
          { name: 'めろん',       emoji: '🍈', imageUrl: 'images/cards/foods/melon.png' },
          { name: 'にんじん',     emoji: '🥕', imageUrl: 'images/cards/foods/ninjin.png' },
          { name: 'とまと',       emoji: '🍅', imageUrl: 'images/cards/foods/tomato.png' },
          { name: 'きゅうり',     emoji: '🥒', imageUrl: 'images/cards/foods/kyuuri.png' },
          { name: 'とうもろこし', emoji: '🌽', imageUrl: 'images/cards/foods/toumorokoshi.png' },
          { name: 'ほうれんそう', emoji: '🥬', imageUrl: 'images/cards/foods/hourensou.png' }
        ]
      },
      {
        id: 'vehicles', name: 'のりもの', color: '#bcdce4',
        cards: [
          { name: 'でんしゃ',       emoji: '🚃', imageUrl: 'images/cards/vehicles/densha.png' },
          { name: 'バス',           emoji: '🚌', imageUrl: 'images/cards/vehicles/basu.png' },
          { name: 'タクシー',       emoji: '🚕', imageUrl: 'images/cards/vehicles/takushii.png' },
          { name: 'ひこうき',       emoji: '✈️', imageUrl: 'images/cards/vehicles/hikouki.png' },
          { name: 'ふね',           emoji: '⛵', imageUrl: 'images/cards/vehicles/fune.png' },
          { name: 'じてんしゃ',     emoji: '🚲', imageUrl: 'images/cards/vehicles/jitensha.png' },
          { name: 'オートバイ',     emoji: '🏍️', imageUrl: 'images/cards/vehicles/ootobai.png' },
          { name: 'しょうぼうしゃ', emoji: '🚒' },
          { name: 'きゅうきゅうしゃ',emoji: '🚑' },
          { name: 'パトカー',       emoji: '🚓' },
          { name: 'トラック',       emoji: '🚛' },
